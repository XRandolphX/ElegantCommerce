package com.xrandolphx.elegantcommerce.fragment.settings
...
import com.xrandolphx.elegantcommerce.databinding.FragmentOrderDetailBinding
...
class OrderDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            tvFullName.text = order.addressOrder.fullName
            tvAddress.text = "${order.addressOrder.location} ${order.addressOrder.addressBill}"
            tvPhoneNumber.text = order.addressOrder.phone
