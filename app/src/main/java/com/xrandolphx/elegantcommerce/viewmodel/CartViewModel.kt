...
class CartViewModel @Inject constructor(
    ...
    fun changeQuantity(
        ...
        /**
         * index podría ser igual a -1 si la función [getCartProducts] se retrasa lo que también
         * retrasará el resultado que esperamos que esté dentro de [_cartProducts] y para evitar
         * que la aplicación se cuelgue hacemos una comprobación
         */
